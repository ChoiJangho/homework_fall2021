...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            observations = ob_no[np.arange(i, num_data, self.ensemble_size).tolist()]
            actions = ac_na[np.arange(i, num_data, self.ensemble_size).tolist()]
            next_observations = next_ob_no[np.arange(i, num_data, self.ensemble_size).tolist()]
